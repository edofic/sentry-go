...
func TestSplitQualifiedFunctionName(t *testing.T) {
	tests := []struct {
		...
		{
			"github.com/edofic/sentry-go.Init",
			"github.com/edofic/sentry-go",
			"Init",
		},
		{
			"github.com/edofic/sentry-go.(*Hub).Flush",
			"github.com/edofic/sentry-go",
			"(*Hub).Flush",
		},
		{
			"github.com/edofic/sentry-go.Test.func2.1.1",
			"github.com/edofic/sentry-go",
			"Test.func2.1.1",
		},
		{
			"github.com/edofic/confusing%2epkg%2ewith%2edots.Test.func1",
			"github.com/edofic/confusing%2epkg%2ewith%2edots",
			"Test.func1",
		},
	}
			...
			in: []Frame{
				{
					...
					Module:   "github.com/edofic/sentry-go/http/integration",
					AbsPath:  "/somewhere/sentry/sentry-go/http/integration/integration.go",
					InApp:    true,
				},
				{
					Function: "(*Handler).Handle",
					Module:   "github.com/edofic/sentry-go/http",
